-- Database setup for Maikekai Surf Hotel
...
-- Sample surf packages
INSERT INTO public.surf_packages (name, description, duration, price, includes, image, difficulty, max_students, equipment, accommodation, meals, transport) VALUES
(
...
-- Sample reviews
INSERT INTO public.reviews (author, rating, comment, date, source, verified, avatar) VALUES
(
    'Sarah Johnson',
    5,
