      ...
      >
        ...
        <div className="p-6 h-[calc(90vh-200px)] overflow-y-auto">
          <div className="text-center py-20">
            <h3 className="text-xl font-semibold text-gray-600 mb-2">Performance Dashboard</h3>
            <p className="text-gray-500">Performance monitoring has been disabled for better performance.</p>
          </div>
        </div>
      </div>
    </div>
