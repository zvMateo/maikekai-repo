...
const Reviews = () => {
  ...
  const fallbackReviews = [
    {
      ...
      country: "USA",
      comment:
        "Pura vida! The instructors were incredible. I caught my first wave in 3 days. This place changed my life.",
      date: "2024-01-15",
      package: "Beginner",
      rating: 5,
      avatar: "S",
    },
    {
      ...
      country: "Canada",
      comment:
        "Perfect waves, perfect instructors, perfect vibes. Will definitely be back next season!",
      date: "2024-01-10",
    ...
    },
    {
      ...
      country: "UK",
      comment:
        "As a beginner, I was nervous but the team made me feel so comfortable. The beachfront location is stunning!",
      date: "2024-01-08",
      package: "Beginner",
      rating: 5,
      avatar: "E",
    },
    {
      ...
      country: "Australia",
      comment:
        "Professional operation from start to finish. ISA certified instructors and top quality equipment.",
      date: "2024-01-05",
      package: "Intermediate",
      rating: 5,
      avatar: "D",
    },
    {
      ...
      country: "Germany",
      comment:
        "The advanced coaching was exactly what I needed. Big wave training and video analysis helped me improve so much.",
      date: "2024-01-03",
      package: "Advanced",
      rating: 5,
      avatar: "L",
    },
    {
      ...
      country: "France",
      comment:
        "Great value! Everything included - accommodation, meals, transport, equipment. Perfect for year-round surfing.",
      date: "2024-01-01",
      package: "Weekend",
      rating: 5,
      avatar: "T",
  ...
  const displayTotalReviews =
    totalReviews > 0 ? totalReviews : fallbackReviews.length;
  ...
  return (
    <section
      id="reviews"
      className="py-24 bg-gradient-to-br from-surf-light/20 via-white to-surf-light/10 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20 animate-fade-in">
          ...
          <p className="text-xl text-surf-blue/80 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="text-logo-teal-500 font-semibold">
              {" "}
          ...
          <div className="relative max-w-5xl mx-auto animate-scale-in">
                    ...
                    <div className="flex items-center space-x-1 mb-6">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          ...
                          size={20}
                          className={`${
                            i < (displayReviews[currentReview]?.rating || 0)
                              ? "text-surf-sand fill-current"
                              : "text-gray-300"
                          }`}
                        />
                      ...
                      <div className="flex items-center space-x-6">
                        ...
                        <div>
                          ...
                          <div className="text-surf-blue/70 text-lg">
                            {displayReviews[currentReview]?.country ||
                              "Unknown"}{" "}
                            •{" "}
                            {formatDate(
                              displayReviews[currentReview]?.date ||
                                displayReviews[currentReview]?.created_at ||
                                ""
                            )}
                          </div>
                        </div>
            ...
            <div className="flex items-center justify-center mt-12 space-x-8">
              ...
              >
                <SkipBack
                  size={20}
                  className="text-surf-navy group-hover:text-white transition-colors"
                />
                <span className="text-surf-navy group-hover:text-white font-medium transition-colors">
                  Previous
                </span>
              </button>
